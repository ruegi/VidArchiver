...
# Form implementation generated from reading ui file 'VidArchiverUINeu.ui'
#
...
"alternate-background-color: rgb(170, 255, 127);")
        self.tbl_film.setEditTriggers(QtWidgets.QAbstractItemView.DoubleClicked)
        ...
        self.btn_delPrep.raise_()
        self.btn_renamePrep.raise_()
        self.btn_showPrepVideo.raise_()
        self.tbl_film.raise_()
...
"alternate-background-color: rgb(255, 226, 176);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_delPrep.setText(_translate("MainWindow", "&löschen"))
        self.btn_renamePrep.setText(_translate("MainWindow", "&umbenennen"))
        self.btn_showPrepVideo.setText(_translate("MainWindow", "&zeigen"))
